...
You can see evidence for the movement in [#criterion-7](4.1-evaluation-of-success-criteria.md#criterion-7 "mention"). In my game, I decided to use the arrow keys for movement.
