...
| 10        | The player will look at the mouse                                                                                  | <p><a data-mention href="../design-and-development/2.2.4-cycle-4.md">2.2.4-cycle-4.md</a><br><a data-mention href="../design-and-development/2.2.7-cycle-7.md">2.2.7-cycle-7.md</a></p> |
...
I wanted to add a sight which would act the same as the cursor to make the place that the player was firing at more clear. I did not do this as I did not have time and it was not necessary for the functionality of the game. This would be a nice feature to add in the future as this would mean that the player would be much more able to find the cursor and quicker and this would make playing the game and the whole control system more enjoyable.
