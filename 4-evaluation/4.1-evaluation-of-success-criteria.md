...
| 23        | The game should be made of darker colours.                                                              | Achieved in usability testing                   |
...
I did not include any sexual references and I only had small amounts of violence. This game would be suitable for the audience that I was intending it for.

### Criterion 20

I made different rates of spawning and high damage values to make the game more difficult. The map I created also made it hard for the people as they could not skip killing all of the zombies if they wanted to complete the game.
...
The game consistently performed at 60fps no matter how much stress I put on it.

### Criterion 23

I made the map and the players model from mostly darker colours like greys and greens except when I needed something contrasting something else.

### Criterion 24

The map that I made was based around the layout of a town.

### Criterion 25

I created a tutorial which appeared for a certain amount of time at the start of the game which outlined how to play the game and the objectives.
