...
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Structures breaking   | I think this is essential to provide the game with some difficulty and will prevent players from just running inside to hide from zombies.                                                                               |
...
| Zombies               | I will include zombies which will be the main enemy in my game as it is in Project Zomboid.                                                                                                                              |
| Tracking              | The zombies in Project Zomboid track the player instead of just following a pre-made path and this is what I want to achieve in my game.                                                                                 |
...
This game is not an open-world(meaning completely unlimited exploration in the map) and the player is forced to play the story in the order the game intended and the only thing that the player can do is main story objectives. This means that the game is much more to the point, simple, and easier to pick-up.
...
| Linear levels             | This game has a very linear structure which completly stops the player from exploring which I will not be doing.                                                                                  |
...
| Story                     | This will be unnecessary for my game as the and will only take up time. Also game progression can be prompted in other ways.                                                                      |
{% endtab %}
{% endtabs %}
