...
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Structures            | I think that there should be some places in the map that it is harder for the zombies to get to so that the player can take their time with the game and this will make the game more enjoyable.  |
...
| Building and breaking structures | This is a feature that is not necessary so I will not include it and I can just make it so that the structures are open so that the zombies can get in anyway.                                              |
{% endtab %}
{% endtabs %}
