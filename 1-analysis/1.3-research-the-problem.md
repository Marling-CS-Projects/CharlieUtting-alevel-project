...
The game is on XBOX so uses a XBOX-360 controller with two joysticks, the left joystick is used for movement, 4 buttons(A, B, C, and D) which are used for attacking and interacting with things in game.
