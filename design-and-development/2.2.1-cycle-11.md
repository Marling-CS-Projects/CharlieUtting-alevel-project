...
* Game Over - This will both make the game functional and improve the user experience due to the ending game state will be clear as large red text will appear on the screen.&#x20;
