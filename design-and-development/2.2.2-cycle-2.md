...
![I made the map larger and the player loads in. The textures that I used were only for the development tests as I have not created the tileset yet and will not be used in the final version.](<../.gitbook/assets/image (6).png>)
