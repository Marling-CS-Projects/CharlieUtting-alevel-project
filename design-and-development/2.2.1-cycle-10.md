...
| ---- | -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | --------- |
| 1    | Run code             | There should be multiple zombies around the map. The player's health should be displayed at the top right of the screen.                                    | As expected.          | Pass      |
| 2    | Run into the zombie. | You should collide with the zombie. The player's health in the top right should go down.                                                                    | As expected.          | Pass      |
| 3    | Shoot the zombie.    | The zombie should disappear after 5 shots as the health is 100 and you inflict 20 damage(until the amount of damage is upgraded when you hit the ironGoal). | As expected.          | Pass      |
