...
| map           | This will be the                                                       |
| tileset       | Variable to hold the amount the player has scored whilst playing.      |
| belowLayer    | Used to display the score text at the top left of the screen.          |
| worldLayer    |                                                                        |
| aboveLayer    |                                                                        |
| camera        |                                                                        |
| debugGraphics |                                                                        |
