...
| 2 - Efficient      | Are the controls easy to use? Does the player move too fast? If you could change any of the controls, what would you change, if anything?           |
| 3 - Engaging       | Does the game make you want to continue playing or become better? Do you like the art style?/Does the game look like a town? Is the game difficult? |
| 4 - Error Tolerant | If there were any bugs, what were they? How many times did the game crash?                                                                          |
| 5 - Easy to Learn  | Is it clear when you have failed the game(Game Over)? Are the controls easy to pick-up.                                                             |
